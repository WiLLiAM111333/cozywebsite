...
export class PandaController extends Controller {
  ...
  public getFact(): (req: Request, res: Response) => Promise<void> {
    return async (req, res) => {
      const data = await this.animalManager.getPandaFact()
  ...
  public getImage(): (req: Request, res: Response) => Promise<void> {
    return async (req, res) => {
      const data = await this.animalManager.getPandaImage();
  ...
  public getData(): (req: Request, res: Response) => Promise<void> {
    return async (req, res) => {
      const data = await this.animalManager.getPandaData();
