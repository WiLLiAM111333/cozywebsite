...
export class FoxController extends Controller {
  ...
  public getFact(): (req: Request, res: Response) => Promise<void> {
    return async (req, res) => {
      const data = await this.animalManager.getFoxFact()
  ...
  public getImage(): (req: Request, res: Response) => Promise<void> {
    return async (req, res) => {
      const data = await this.animalManager.getFoxImage();
  ...
  public getData(): (req: Request, res: Response) => Promise<void> {
    return async (req, res) => {
      const data = await this.animalManager.getFoxData();
